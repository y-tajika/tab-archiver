...
async function saveAllTabs(customFolderName = null) {
  try {
    ...
    if (settings.windowSaveMode === 'all-windows') {
      return await saveAllTabsAllWindows(customFolderName, settings);
    } else {
      return await saveAllTabsCurrentWindow(customFolderName, settings);
    }
  } catch (error) {
 ...
 */
async function saveAllTabsCurrentWindow(customFolderName, settings) {
 ...
 */
async function saveAllTabsAllWindows(customFolderName, settings) {
